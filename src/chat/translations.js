...
export const translations = {
    en: {
        ...
        commsOfflineHint: '▸ TAP HERE TO OPEN LLM SETTINGS',
        welcomeBackShort: 'Link re-established. You were dark for a while there, operator.',
        welcomeBackMedium: '{days} days of radio silence. Started monitoring other channels. Good to have you back.',
        welcomeBackLong: '{days} DAYS dark. I filed a missing operator report. Glad it was premature.',
        contractBrief: '📋 ACTIVE DIRECTIVE: {brief} [{progress}/{target}] — BOUNTY: {bounty} XP',
        contractDone: '✅ Today\'s directive complete. Bounty collected.',
    ...
    zh: {
        ...
        commsOfflineHint: '▸ 点击此处打开LLM设置',
        welcomeBackShort: '链接重新建立。你离线了好一阵，行动员。',
        welcomeBackMedium: '{days} 天无线电静默。我开始监听其他频道了。欢迎回来。',
        welcomeBackLong: '整整 {days} 天失联。我都提交了失踪报告。幸好是虚惊一场。',
        contractBrief: '📋 当前指令：{brief} [{progress}/{target}] — 赏金：{bounty} XP',
        contractDone: '✅ 今日指令已完成。赏金已领取。',
        linkFailure: '链接失败',
        err: '错误',
        copy: '复制',
        copied: '已复制',
